...
<html lang="en">
  <head>
    ...
    <!-- Favicon and Icons -->
    <link rel="icon" type="image/svg+xml" href="/favicon.svg?v=<?php echo $timestamp; ?>" />
    <link rel="icon" type="image/x-icon" href="/favicon.ico?v=<?php echo $timestamp; ?>" />
    <link rel="apple-touch-icon" href="/tradebuddy-logo.svg?v=<?php echo $timestamp; ?>" />
    
    <!-- PWA Manifest -->
    <link rel="manifest" href="/manifest.json?v=<?php echo $timestamp; ?>" />
    ...
    <script>
      ...
      (function() {
        console.log('🔥 ULTRA CACHE BUST: Starting aggressive cache clearing');
        ...
        if (lastReload && (currentTime - parseInt(lastReload)) < 5000) {
          console.log('🔥 FORCE RELOAD: Too soon, skipping');
          return;
        }
      ...
      if ('serviceWorker' in navigator) {
        window.addEventListener('load', () => {
          ...
          navigator.serviceWorker.getRegistrations().then(function(registrations) {
            ...
            navigator.serviceWorker.register('/sw-aggressive.js?v=<?php echo $timestamp; ?>')
              .then((registration) => {
                console.log('🔥 ULTRA-AGGRESSIVE SW REGISTERED:', registration);
    ...
    <script type="module" crossorigin src="/assets/index-1757709663334-58Sycgly.js?v=<?php echo $timestamp; ?>&nocache=1&bust=<?php echo $random; ?>"></script>
    <link rel="stylesheet" crossorigin href="/assets/index-1757709663334-58Sycgly.css?v=<?php echo $timestamp; ?>&nocache=1&bust=<?php echo $random; ?>">
  </head>
    ...
    <script>
      ...
      navigator.serviceWorker.addEventListener('message', function(event) {
        if (event.data && event.data.type === 'FORCE_RELOAD') {
          console.log('🔥 SW MESSAGE: Force reload received');
