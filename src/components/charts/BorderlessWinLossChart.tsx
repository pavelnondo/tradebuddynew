...
interface BorderlessWinLossChartProps {
  data: Array<{ label: string; value: number; color?: string }>;
  loading?: boolean;
  error?: string;
}

export function BorderlessWinLossChart({ data, loading, error }: BorderlessWinLossChartProps) {
  ...
  // Calculate donut chart dimensions - use full available space
  const size = 100; // Use percentage
